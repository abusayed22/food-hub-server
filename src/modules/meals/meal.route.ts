...
route.patch("/:mealId",authMiddleware(Role.admin,Role.provider),mealsController.updateMeal); 
route.delete("/:mealId",authMiddleware(Role.admin,Role.provider),mealsController.deleteMeal); 
